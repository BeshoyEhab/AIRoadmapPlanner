...
import { Brain, Sparkles, Loader, AlertCircle, Play, Target, Lightbulb, Rocket } from 'lucide-react';
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            ...
            Define your goals and let our intelligent system create a comprehensive study plan tailored just for you.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
            <div className="flex items-center gap-3 mb-2">
              <Sparkles size={24} />
              <h2 className="text-xl font-semibold">Create Your Learning Path</h2>
            </div>
            <p className="text-blue-100 text-sm">
              Provide your learning objective and final goal to generate a detailed, actionable roadmap
            </p>
          </div>
          ...
          <div className="p-6 sm:p-8 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <label htmlFor="objective" className="block text-lg font-semibold text-gray-800 dark:text-white">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="flex items-center justify-center w-8 h-8 bg-green-100 dark:bg-green-900 rounded-lg">
                  <Rocket className="text-green-600 dark:text-green-400" size={18} />
                </div>
                <div>
                  <label htmlFor="finalGoal" className="block text-lg font-semibold text-gray-800 dark:text-white">
            ...
            <div className="pt-4 space-y-4">
              {isResumable && !loading && (
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-4">
                  <div className="flex items-center gap-2 text-yellow-800 dark:text-yellow-200 mb-2">
                    <AlertCircle size={18} />
                    <span className="font-medium">Incomplete Roadmap Detected</span>
                  </div>
                  <p className="text-sm text-yellow-700 dark:text-yellow-300">
                    You have a partially generated roadmap. You can resume generation or start fresh.
                  </p>
                </div>
              )}
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className={`${isResumable ? 'flex-1' : 'w-full'} bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 
              ...
              {loading && (
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-blue-800 dark:text-blue-200">
                        {loadingMessage || 'Generating your personalized roadmap...'}
                      </p>
                  ...
                  <div className="mt-3 bg-blue-200 dark:bg-blue-800 rounded-full h-1">
                    <div className="bg-blue-600 dark:bg-blue-400 h-1 rounded-full animate-pulse" style={{width: '45%'}}></div>
                  </div>
                </div>
              )}
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 text-center">
            ...
            <h3 className="font-semibold text-gray-800 dark:text-white text-sm mb-1">AI Powered</h3>
