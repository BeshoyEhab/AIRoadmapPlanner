...
const SavedPlansTab = ({
  ...
  const renderRoadmapCard = (timeplan) => (
    ...
    >
      ...
      {/* Card Footer */}
      <div className="px-0 py-0 bg-gray-50/80 dark:bg-gray-700/80 border-t border-gray-200/50 dark:border-gray-600/50 backdrop-blur-sm">
        <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-gray-600">
          ...
          <div className="relative group/regenerate p-2.5 hover:bg-gray-100/50 dark:hover:bg-gray-600/30 transition-colors">
            <button
              onClick={(e) => {
                e.stopPropagation();
                // TODO: Add regenerate functionality here
                console.log('Regenerate roadmap:', timeplan.id);
              }}
              className="w-full h-full flex items-center justify-center gap-2 text-sm font-medium text-gray-600 hover:text-green-600 dark:text-gray-300 dark:hover:text-green-400 transition-colors"
            >
              <RefreshCw size={16} className="transition-transform group-hover/regenerate:rotate-180" />
